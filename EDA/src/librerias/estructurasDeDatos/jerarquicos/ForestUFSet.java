...
/**
 * Clase que implementa el interfaz MFSet con coste amortizado prácticamente
 * constante Cada subconjunto se guarda como un árbol: - Los nodos del árbol son
 * los elementos del subconjunto: 0, 1, 2, .., talla - En cada nodo guardamos
 * una referencia al padre - El elemento raíz del árbol se usa para representar
 * el subconjunto
 */
public class ForestUFSet implements UFSet {
	...
	/**
	 * que devuelve el número de elementos que tiene el conjunto de la clase de
	...
	/**
	 * que devuelve el número de elementos que tendría el conjunto unión de las
